...
export const OFFICIAL_TERMS_HTML = `
<div style="font-family: system-ui, -apple-system, sans-serif; line-height: 1.6; color: #334155; max-width: 100%;">
  <div style="text-align: center; border-bottom: 2px solid #e2e8f0; padding-bottom: 1.25rem; margin-bottom: 1.5rem;">
    ...
    <h3 style="font-size: 1.25rem; font-weight: 800; color: #1e293b; margin: 0 0 0.5rem 0;">MASTER DISCLAIMER, PRIVACY NOTICE & TERMS OF USE</h3>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h4 style="font-size: 1.1rem; font-weight: 800; color: #0f172a; margin-top: 1.25rem; margin-bottom: 0.5rem;">1. INTRODUCTION</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART A – MEDICAL AND HEALTH DISCLAIMER</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">2. NOT A SUBSTITUTE FOR MEDICAL CARE</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART B – MITOREBOOT SCORES AND ALGORITHMS</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">3. DAMAGE, REPAIR, RISK AND OTHER SCORES</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">4. ALGORITHMS, ARTIFICIAL INTELLIGENCE AND AUTOMATED OUTPUTS</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART C – HEALTH, CGM AND WEARABLE DATA</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">5. HEALTH INFORMATION</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">6. CGM AND CONNECTED DEVICE DISCLAIMER</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART D – FASTING, NUTRITION AND LIFESTYLE</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">7. FASTING AND DIETARY INFORMATION</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART E – ENVIRONMENTAL EXPOSURE</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">8. ENVIRONMENTAL EXPOSURE INFORMATION</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART F – CANCER AND PREVENTION</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">9. CANCER RISK DISCLAIMER</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART G – RESEARCH AND SCIENTIFIC INFORMATION</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">10. SCIENTIFIC AND RESEARCH INFORMATION</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART H – PRIVACY AND DATA PROTECTION</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">11. INFORMATION WE COLLECT</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">12. PURPOSE OF DATA PROCESSING</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">13. CONSENT</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">14. DATA SHARING</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">15. DE-IDENTIFIED AND AGGREGATED INFORMATION</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">16. DATA SECURITY</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">17. DATA RETENTION</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">18. USER PRIVACY RIGHTS</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART I – THIRD-PARTY SERVICES AND PRODUCTS</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">19. THIRD-PARTY PLATFORMS</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">20. THIRD-PARTY PRODUCTS AND SERVICES</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART J – PAYMENTS AND SUBSCRIPTIONS</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">21. PAYMENTS</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">22. SUBSCRIPTIONS</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART K – EMERGENCY AND SAFETY</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">23. EMERGENCY DISCLAIMER</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART L – CHILDREN</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">24. MINORS</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART M – USER RESPONSIBILITY</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">25. USER-PROVIDED INFORMATION</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">26. ACCOUNT SECURITY</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART N – LIMITATION OF LIABILITY</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">27. LIMITATION OF LIABILITY</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART O – INTELLECTUAL PROPERTY</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">28. OWNERSHIP</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART P – CHANGES TO SERVICES AND DOCUMENT</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">29. MODIFICATION OF SERVICES</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">30. CHANGES TO THIS DOCUMENT</h4>
  ...
  <div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.35rem; margin-top: 1.5rem; margin-bottom: 0.75rem;">PART Q – GOVERNING LAW AND GRIEVANCE</h3>
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">31. GOVERNING LAW</h4>
    ...
    <h4 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">32. PRIVACY AND GRIEVANCE CONTACT</h4>
  ...
  <div style="background-color: #f8fafc; border: 1px solid #cbd5e1; padding: 1.25rem; border-radius: 0.875rem; margin-top: 1.5rem; margin-bottom: 1.5rem;">
    ...
    <div style="background: white; border: 1px solid #e2e8f0; padding: 1rem; border-radius: 0.5rem; font-size: 0.875rem; color: #1e293b; margin-top: 1rem; line-height: 1.8;">
...
async function run() {
  try {
    ...
    await LegalDocument.deleteMany({ type: 'TermsOfService' });
    console.log('Deleted old TermsOfService data.');

    // Create fresh official document
    await LegalDocument.create({ type: 'TermsOfService', content: OFFICIAL_TERMS_HTML });
    console.log('Successfully seeded fresh TermsOfService document in database!');
    process.exit(0);
  } catch (err) {
    console.error('Error updating TermsOfService in DB:', err);
    process.exit(1);
  }
}
