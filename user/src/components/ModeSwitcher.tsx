          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <button
                ...
                className="w-full sm:flex-1 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-semibold order-2 sm:order-1"
                disabled={isSaving}
              >
                Decline
              </button>
              <button
                ...
                className="w-full sm:flex-1 py-2.5 bg-primary hover:bg-primary/90 dark:bg-primary-dark text-white rounded-xl text-xs font-semibold shadow-soft flex items-center justify-center order-1 sm:order-2"
                disabled={isSaving}
              >
